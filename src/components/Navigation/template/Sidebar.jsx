...
const SidebarTemplate = () => {
  ...
  return (
    <>
      <aside class="ml-[-100%] fixed z-10 top-0 pb-3 px-4 w-full flex flex-col justify-between h-screen border-r shadow-lg bg-white transition duration-300 md:w-[15%] lg:ml-0 lg:w-[25%] xl:w-[15%] 2xl:w-[15%]">
        <div>
